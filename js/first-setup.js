...
(() => {
  ...
  const T = ar
    ? {
        ...
        adhanHint: "نفس الضغطة تفعّل الأذان وتفتح إعدادات التوصيل في وقتها (التنبيه الدقيق والبطارية).",
    ...
    : {
        ...
        adhanHint: "The same tap turns on Adhan and opens on-time delivery settings (exact alarms and battery).",
