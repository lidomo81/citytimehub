...
(function () {
  ...
  const S = {
    ...
    prayerRemind: { sel: "#cthAppSettingsBtn", tab: "prayer", prefer: "below",
      ar: { t: "مركز الإشعارات ⚙️", b: "زر الإعدادات أعلى الصفحة يفتح التحكم في إشعارات الصلاة: اختيار المدينة، تفعيل الصلوات، نغمة الأذان، والعداد في شريط الحالة." },
      en: { t: "Notification Center ⚙️", b: "The settings gear at the top opens Prayer notifications: pick your city, enable prayers, choose an adhan sound, and the status-bar countdown." } },
    ...
    azkarRemind: { sel: "#cthAppSettingsBtn", tab: "azkar", prefer: "below",
      ar: { t: "تذكير الأذكار 🌙", b: "اضغط زر الإعدادات أعلى الصفحة لتفعيل تنبيه أذكار الصباح والمساء وجمعة الذكر." },
      en: { t: "Adhkar reminders 🌙", b: "Tap the settings gear at the top to enable alerts for morning, evening and Friday adhkar." } },
    widgetsApp: { sel: null,
