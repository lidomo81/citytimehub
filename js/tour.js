...
(function () {
  ...
  const S = {
    ...
    appSettings: { sel: "#cthAppSettingsBtn", prefer: "below",
      ar: { t: "الإعدادات ⚙️", b: "زر الإعدادات أعلى الشاشة يفتح قائمة واحدة من كل التبويبات: إشعارات الصلاة، تذكيرات الأذكار (صباح، مساء، وذكر الجمعة)، وإعدادات عرض الساعة (12 أو 24 ساعة)." },
      en: { t: "Settings ⚙️", b: "The gear at the top opens the same organized menu from every tab: prayer notifications, adhkar reminders (morning, evening, and Friday adhkar), and clock display (12- or 24-hour)." } },
    ...
    help: { sel: "#helpBtn", prefer: "above",
      ar: { t: "المساعدة ❓", b: "زر «؟» يعيد الجولة التعريفية في أي وقت، أو يفتح قائمة بكل الميزات." },
      en: { t: "Help ❓", b: "The “?” button replays this tour anytime, or opens the full feature list." } },
