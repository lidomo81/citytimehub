...
(function () {
  ...
  const S = {
    ...
    azkarRemind: { sel: "#notifCenterBtn", tab: "azkar", prefer: "below",
      ar: { t: "تذكير الأذكار 🌙", b: "اضغط زر الجرس أعلى الصفحة لتفعيل تنبيه أذكار الصباح والمساء وجمعة الذكر." },
      en: { t: "Adhkar reminders 🌙", b: "Tap the bell icon at the top to enable alerts for morning, evening and Friday adhkar." } },
    widgetsApp: { sel: null,
