...
(function () {
  ...
  const S = {
    ...
    appSettings: { sel: "#cthAppSettingsBtn", prefer: "below",
      ar: { t: "الإعدادات ⚙️", b: "زر الإعدادات أعلى الشاشة يفتح قائمة واحدة من كل التبويبات: إشعارات الصلاة، تذكيرات الأذكار، وإعدادات عرض الساعة (12 أو 24 ساعة)." },
      en: { t: "Settings ⚙️", b: "The gear at the top opens the same organized menu from every tab: prayer notifications, adhkar reminders, and clock display (12- or 24-hour)." } },
