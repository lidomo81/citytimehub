...
(function () {
  ...
  const S = {
    ...
    appNav: { sel: ".app-bottom-nav", tab: "home", prefer: "above",
      ar: { t: "التبويبات السفلية 📱", b: "الرئيسية: وقتك ومدينتك. الصلاة: المواقيت والتذكير. الأذكار: استيقاظ وصباح ومساء ونوم. الأدوات: باقي الميزات." },
      en: { t: "Bottom tabs 📱", b: "Home: your time and city. Prayer: times and reminders. Adhkar: waking, morning, evening and bedtime. Tools: everything else." } },
    ...
    azkarHub: { sel: ".app-azkar-grid", tab: "azkar", prefer: "below",
      ar: { t: "تبويب الأذكار 📿", b: "هنا أذكار الاستيقاظ والصباح والمساء وقبل النوم — كل مجموعة بعدّاد تكرار وحفظ تلقائي على جهازك." },
      en: { t: "Adhkar tab 📿", b: "Waking, morning, evening and bedtime adhkar — each set has a tap counter and auto-save on your device." } },
